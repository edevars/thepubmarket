/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 4cc0e28513adba41dc492a2f6ed38d56)
...
interface __BaseEnv_Env {
	...
	RESERVATION: DurableObjectNamespace<import("./src/index").InventoryReservation>;
	POST_PAYMENT: Workflow<Parameters<import("./src/index").PostPaymentWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "InventoryReservation";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PLATFORM_FEE_BPS" | "EMAIL_MODE" | "EMAIL_FROM" | "EMAIL_FROM_NAME" | "ADMIN_API_KEY" | "STRIPE_SECRET_KEY" | "STRIPE_WEBHOOK_SECRET" | "WEB_BASE_URL" | "TURNSTILE_SECRET_KEY">> {}
}
